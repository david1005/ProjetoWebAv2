...
<html>
    ...
    <body>
        <div class="container" align="center"> 
            ...
            <div class="col-md-4">
                <input id="usuario" name="user.userName" value="${user.userName}" type="text" class="form-control input-md" placeholder="Usuário">    
            </div>

            <div class="col-md-4" align="center">
                <input id="senha" name="user.password" value="${user.password}" type="password" class="form-control input-md" placeholder="*********">
            </div>
        </div>
        <br>
        <div align="center">
